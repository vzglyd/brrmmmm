...
function buildHelpLines(describe: ModuleDescribe | null): string[] {
  ...
  return [
    ...
    "daemon run: keep the mission daemon in the foreground for service use.",
    ...
    "",
    "# Keys",
    "List view: ↑/↓ select mission · Enter open detail · l or n open launcher.",
    "List view: f retry · Space hold/resume · x abort.",
    "Detail view: Esc or b back to list · Tab cycles pipeline/raw/output panels.",
    "Detail view: f retry · Space hold/resume · x abort · l or n open launcher.",
    "Launcher: Tab or f on WASM path field opens inline file browser.",
    "  File browser: ↑/↓ browse · Enter select file or enter dir · Esc cancel.",
    "  Tab moves between other launcher fields.",
